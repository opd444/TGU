...
import com.unicauca.tgu.entities.Programa;
import com.unicauca.tgu.jsf.util.JsfUtil;
import com.unicauca.tgu.jsf.util.PaginationHelper;
import com.unicauca.tgu.jpacontroller.ProgramaFacade;
...
public class ProgramaController implements Serializable {
    ...
    @EJB
    private com.unicauca.tgu.jpacontroller.ProgramaFacade ejbFacade;
    ...
    public static class ProgramaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Programa) {
                ...
                return getStringKey(o.getProgramaid());
            } else {
