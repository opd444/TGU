...
import com.unicauca.tgu.jpacontroller.NotificacionFacade;
...
public class NotificacionController implements Serializable {
    ...
    @EJB
    private com.unicauca.tgu.jpacontroller.NotificacionFacade ejbFacade;
    ...
    public static class NotificacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Notificacion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Notificacion.class.getName());
            }
        }
